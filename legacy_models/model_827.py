...
class Dcpbst(nn.Module):
    def __init__(self, features, sparse=False,
        ...
        if "Ground Truth" in self.adata.obs:
            print("'Ground Truth' found, preparing labels for supervised learning...")
    ...
    def forward(self,y_true=None):
        ...
        self.spatial_s=torch.from_numpy(self.adata.obsm['feat_spot']).float().to(self.device)  # Spatial feature expression graph
